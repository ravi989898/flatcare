...
@section('content')
    <div class="card stat-card">
        ...
        <form action="{{ route('society.admins.update', $admin->id) }}" method="POST" novalidate>
            ...
            <div class="card-body">
                <div class="mb-3">
                    <label class="font-weight-bold mb-1 d-block">Full Name <span class="text-danger">*</span></label>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label class="font-weight-bold mb-1 d-block">Email <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-6 mb-3">
                        <label class="font-weight-bold mb-1 d-block">Phone <span class="text-danger">*</span></label>
