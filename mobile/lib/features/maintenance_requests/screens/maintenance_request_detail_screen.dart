...
class MaintenanceRequestDetailScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final request = ref.watch(maintenanceRequestDetailProvider(id));

    return Scaffold(
      appBar: AppBar(title: const Text('Request Details')),
      body: AsyncView<MaintenanceRequest>(
        value: request,
        onRetry: () => ref.invalidate(maintenanceRequestDetailProvider(id)),
