...
class RoleMenuSettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $menuItems = [
            ...
            ['key' => 'blocks', 'label' => 'Blocks', 'route_name' => 'society.blocks.index', 'icon' => 'bi-building', 'display_order' => 3],
            ['key' => 'security', 'label' => 'Security', 'route_name' => 'society.security.index', 'icon' => 'bi-shield-lock', 'display_order' => 4],
            ['key' => 'maintenance', 'label' => 'Maintenance', 'route_name' => 'society.maintenance.index', 'icon' => 'bi-tools', 'display_order' => 5],
            ['key' => 'visitors', 'label' => 'Visitors', 'route_name' => 'society.visitors.index', 'icon' => 'bi-person-badge', 'display_order' => 6],
            ['key' => 'complaints', 'label' => 'Complaints', 'route_name' => 'society.complaints.index', 'icon' => 'bi-exclamation-circle', 'display_order' => 7],
            ['key' => 'directory', 'label' => 'Directory', 'route_name' => 'society.directory.index', 'icon' => 'bi-people', 'display_order' => 8],
            ['key' => 'announcements', 'label' => 'Announcements', 'route_name' => 'society.announcements.index', 'icon' => 'bi-megaphone', 'display_order' => 9],
            ['key' => 'events', 'label' => 'Events', 'route_name' => 'society.events.index', 'icon' => 'bi-calendar-event', 'display_order' => 10],
            ['key' => 'elections', 'label' => 'Elections', 'route_name' => 'society.elections.index', 'icon' => 'bi-check2-square', 'display_order' => 11],
            ['key' => 'payments', 'label' => 'Payments', 'route_name' => 'society.payments.index', 'icon' => 'bi-credit-card', 'display_order' => 12],
            ['key' => 'water-readings', 'label' => 'Water Readings', 'route_name' => 'society.water-readings.index', 'icon' => 'bi-droplet', 'display_order' => 13],
